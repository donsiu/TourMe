function SecSearch(NewhubLat,NewhubLng,Category0,num){

  // console.log(NewhubLat);
  // console.log(NewhubLng);
  // console.log(Category0);

  var myLatlng = new google.maps.LatLng(NewhubLat,NewhubLng);
  var mapOptions = {
    zoom: 13,
    center: myLatlng
  }
  ...
  foursquare(categoriesID,TPObject);
                ...
                placeinfof(tmpObject,tmpratinglist,resultprice,hours,resultname,resultformattedphone,resultformattedaddress,resultrating,ratingcolor,tmpPhotoJason,null,resultlat,resultlng,tmpmarker);
                      ...
                      function again(counter){
                            ...
                            success: function(json) {
                                ...
                                var tmpphotourl = photoprefix+"500x500"+photopresuffix;
    ...
    //---------------------- dont need mrintmarker temporariliy--------------------------------------------
                                  ...
                                  if(CatList.length == 8){
                                    ...
                                    // console.log(CatList);
                                    // console.log(Category0);
                                    PrintInfoAccordion(CatList,Category0,map,num);
